...
class CacheOpsSpec extends AmlsSpec {
  ...
  object TestDataClient extends CacheOps
  ...
  ".decryptValue" must {
    ...
    "decrypt empty values from the cache" ignore {
      // todo finish test
    }
  }
}
