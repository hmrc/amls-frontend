    ...
    "templateVersion = v7m0" when {
      ...
      "return correct message content" when {
        ...
        "contact type is RenewalApproval" in new Fixture {
          ...
          val result =
            await(service.getMessageDetails("regNo", "id", ContactType.RenewalApproval, "v7m0", accountTypeId))
        ...
        "contact type is RenewalReminder" in new Fixture {
          ...
          val result =
            await(service.getMessageDetails("regNo", "id", ContactType.RenewalReminder, "v7m0", accountTypeId))
        ...
        "contact type is NewRenewalReminder" in new Fixture {
          ...
          val result =
            await(service.getMessageDetails("regNo", "id", ContactType.NewRenewalReminder, "v7m0", accountTypeId))
        ...
        "content message is ETMP markdown" in new Fixture {
          ...
          val result =
            await(service.getMessageDetails("regNo", "id", ContactType.MindedToRevoke, "v7m0", accountTypeId))
      ...
      "static is called" must {
        ...
        "throw an exception" when {
          ...
          "the wrong contact type is supplied" in {
            ...
            } must have message "An Unknown Exception has occurred, v7m0:static():MessageDetails"
          }
        }
      }
      ...
      "endDate is called" must {
        ...
        "throw an exception" when {
          ...
          "the wrong contact type is supplied" in {
            ...
            } must have message "An Unknown Exception has occurred, v7m0:endDate():MessageDetails"
          }
        }
      }
