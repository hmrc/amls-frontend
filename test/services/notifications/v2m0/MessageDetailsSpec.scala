        ...
        "templateVersion = v2m0" when {
            ...
            "return correct message content" when {
                ...
                "contact type is ReminderToPayForVariation" in new Fixture {
                    ...
                    val result = await(service.getMessageDetails("regNo", "id", ContactType.ReminderToPayForVariation, "v2m0"))
                ...
                "contact type is ReminderToPayForApplication" in new Fixture {
                    ...
                    val result = await(service.getMessageDetails("regNo", "id", ContactType.ReminderToPayForApplication, "v2m0"))
                ...
                "contact type is ReminderToPayForRenewal" in new Fixture {
                    ...
                    val result = await(service.getMessageDetails("regNo", "id", ContactType.ReminderToPayForRenewal, "v2m0"))
                ...
                "contact type is ReminderToPayForManualCharges" in new Fixture {
                    ...
                    val result = await(service.getMessageDetails("regNo", "id", ContactType.ReminderToPayForManualCharges, "v2m0"))
                ...
                "contact type is ApplicationApproval" in new Fixture {
                    ...
                    val result = await(service.getMessageDetails("regNo", "id", ContactType.ApplicationApproval, "v2m0"))
                ...
                "contact type is RenewalApproval" in new Fixture {
                    ...
                    val result = await(service.getMessageDetails("regNo", "id", ContactType.RenewalApproval, "v2m0"))
                ...
                "contact type is AutoExpiryOfRegistration" in new Fixture {
                    ...
                    val result = await(service.getMessageDetails("regNo", "id", ContactType.AutoExpiryOfRegistration, "v2m0"))
                ...
                "contact type is RenewalReminder" in new Fixture {
                    ...
                    val result = await(service.getMessageDetails("regNo", "id", ContactType.RenewalReminder, "v2m0"))
                ...
                "content message is ETMP markdown" in new Fixture {
                    ...
                    val result = await(service.getMessageDetails("regNo", "id", ContactType.MindedToRevoke, "v2m0"))
