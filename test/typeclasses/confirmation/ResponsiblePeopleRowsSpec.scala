...
class ResponsiblePeopleRowsSpec extends PlaySpec {
    ...
    "value is a AmendVariationRenewalResponse" when {
        "businessActivities is None" must {
            ...
            "set BreakdownRows for trading premises full year charge" in {

            }

            "set BreakdownRows for trading premises half year charge" in {

            }

            "set BreakdownRows for trading premises no charge" in {
