...
class your_messages_flattenSpec extends AmlsSpec with MustMatchers {
    ...
    trait ViewFixture extends Fixture {
        ...
        val currentNotifications: Seq[NotificationRow] = Seq(
            NotificationRow(None, None, None, variation = true, new DateTime(2018, 1, 1, 0, 0), isRead = true, "XA000", "1", IDType("id")),
            NotificationRow(Some(Status(Some(Expired), None)), None, None, variation = true, new DateTime(2018, 1, 2, 0, 0), isRead = false, "XA000","1", IDType("id")),
            NotificationRow(None, Some(ApplicationApproval), None, variation = true, new DateTime(2018, 1, 3, 0, 0), isRead = true, "XA000","1", IDType("id")),
            NotificationRow(Some(Status(Some(Approved), None)), Some(RenewalApproval), None, variation = true, new DateTime(2018, 1, 4, 0, 0), isRead = false, "XA000","1", IDType("id")),
            NotificationRow(Some(Status(Some(Rejected), None)), Some(ReminderToPayForVariation), None, variation = true, new DateTime(2018, 1, 5, 0, 0), isRead = true, "XA000","1", IDType("id")),
            NotificationRow(Some(Status(Some(Revoked), None)), Some(RevocationReasons), None, variation = true, new DateTime(2018, 1, 6, 0, 0), isRead = false, "XA000","1", IDType("id")),
            NotificationRow(Some(Status(Some(DeRegistered), None)), Some(AutoExpiryOfRegistration), None, variation = true, new DateTime(2018, 1, 7, 0, 0), isRead = true, "XA000","1", IDType("id")),
            NotificationRow(Some(Status(Some(Expired), None)), Some(MindedToReject), None, variation = true, new DateTime(2018, 1, 8, 0, 0), isRead = false, "XA000","1", IDType("id")),
            NotificationRow(Some(Status(Some(Approved), None)), Some(NoLongerMindedToRevoke), None, variation = true, new DateTime(2018, 1, 9, 0, 0), isRead = true, "XA000","1", IDType("id")),
            NotificationRow(Some(Status(Some(Rejected), None)), Some(RegistrationVariationApproval), None, variation = true, new DateTime(2018, 1, 10, 0, 0), isRead = false, "XA000","1", IDType("id"))
        )
