  ...
  "select_activities view" must {
    "have correct title" when {
      "pre-submission" in new ViewFixture {
        ...
        def view = views.html.businessmatching.updateservice.select_activities(form2, edit = true, Set("01"), Set.empty)
    ...
    "notify of services already selected" when {
      "status is post submission" in new ViewFixture {
        ...
        def view = views.html.businessmatching.updateservice.select_activities(EmptyForm, edit = true, Set("01"), Set.empty)
    ...
    "hide the return to progress link" in new ViewFixture {
      def view = views.html.businessmatching.updateservice.select_activities(EmptyForm, edit = true, Set("01"), Set.empty, showReturnLink = false)
