...
class what_do_you_do_hereSpec extends GenericTestHelper with MustMatchers  {
    ...
    "services view" must {
        "have correct title" in new ViewFixture {
            ...
            def view = views.html.businessmatching.updateservice.add.what_do_you_do_here(form2, edit = true)
        ...
        "hide the return to progress link"in new ViewFixture {
            ...
            def view = views.html.businessmatching.updateservice.add.what_do_you_do_here(form2, edit = true, showReturnLink = false)
