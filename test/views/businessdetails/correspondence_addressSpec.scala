...
import models.businessdetails.{CorrespondenceAddress, UKCorrespondenceAddress}
...
class correspondence_addressSpec extends AmlsSpec with MustMatchers  {
  ...
  "correspondence_address view" must {
    "have correct title" in new ViewFixture {
      ...
      def view = views.html.businessdetails.correspondence_address(form2, true, countries)
