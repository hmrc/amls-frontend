...
class summarySpec extends AmlsSummaryViewSpec with TableDrivenPropertyChecks {
  ...
  "summary view" must {
    ...
    val sectionChecks = Table[String, Element => Boolean](
      ...
      ("businessdetails.registeredforvat.title",checkElementTextIncludes(_, "lbl.yes")),
      ("businessdetails.registeredforvat.lbl.vatNumber",checkElementTextIncludes(_, "2345")),
