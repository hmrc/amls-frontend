...
class AdditionalExtraAddressUKViewSpec extends AmlsViewSpec with MustMatchers {
  ...
  "AdditionalExtraAddressUKView" must {
    ...
    "have correct title" in new ViewFixture {
      ...
      def view = uKView(fp().fill(ResponsiblePersonAddress(PersonAddressUK("","",None,None,""), None)), true, 1, None, name)
