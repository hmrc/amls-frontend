...
class AdditionalAddressViewSpec extends AmlsViewSpec with MustMatchers {
  ...
  "AdditionalAddressView" must {
    ...
    pageWithBackLink(additional_address(fp(), false, 1, None, name))
  }
}
