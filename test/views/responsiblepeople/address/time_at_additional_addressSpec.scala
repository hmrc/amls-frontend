...
class time_at_additional_addressSpec extends AmlsViewSpec with MustMatchers  {

  trait ViewFixture extends Fixture {
    lazy val time_at_additional_address = app.injector.instanceOf[time_at_additional_address]
  ...
  "time_at_additional_address view" must {
    ...
    "have a back link" in new ViewFixture {
      ...
      def view = time_at_additional_address(form2, false, 0, None, "FirstName LastName")
