...
class additional_address_IsUKSpec extends AmlsSpec with MustMatchers {
  ...
  "current_address view" must {
    ...
    "have correct title, headings and form fields" in new ViewFixture {
      ...
      doc.title must be(Messages("responsiblepeople.additional_address_IsUK.title") +
        " - " + Messages("summary.responsiblepeople") +
        " - " + Messages("title.amls") +
        " - " + Messages("title.gov"))
      heading.html must be(Messages("responsiblepeople.additional_address_IsUK.heading", name))
