...
class additional_address_NonUKSpec extends AmlsSpec with MustMatchers {
  ...
  "current_address view" must {
    ...
    "have correct title, headings and form fields" in new ViewFixture {
      ...
      def view = views.html.responsiblepeople.additional_address_NonUK(form2, true, 1, None, name, countries)
