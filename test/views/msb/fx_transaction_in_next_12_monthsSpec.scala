...
class fx_transaction_in_next_12_monthsSpec extends AmlsViewSpec with MustMatchers {

    trait ViewFixture extends Fixture {
        lazy val fx_transaction_in_next_12_months = app.injector.instanceOf[fx_transaction_in_next_12_months]
    ...
    "fx_transaction_in_next_12_months view" must {
        ...
        "have the back link button" in new ViewFixture {
            ...
            def view = fx_transaction_in_next_12_months(form2, true)
