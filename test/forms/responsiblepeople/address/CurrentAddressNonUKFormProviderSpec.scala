...
class CurrentAddressNonUKFormProviderSpec extends AddressFieldBehaviours {

  val formProvider = new CurrentAddressNonUKFormProvider()
  ...
  "CurrentAddressNonUKFormProvider" when {
