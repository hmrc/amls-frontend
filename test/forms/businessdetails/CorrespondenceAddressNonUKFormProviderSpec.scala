...
class CorrespondenceAddressNonUKFormProviderSpec extends AddressFieldBehaviours { //TODO flakey tests

  val formProvider = new CorrespondenceAddressNonUKFormProvider()

  override val form: Form[CorrespondenceAddressNonUk] = formProvider()
  ...
  "CorrespondenceAddressNonUKFormProvider" when {
    ...
    behave like countryField(formProvider.countryErrorKey)
  }
}
