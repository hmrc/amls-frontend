...
class RegisteredOfficeUKFormProviderSpec extends AddressFieldBehaviours {

  val formProvider = new RegisteredOfficeUKFormProvider()
  ...
  "RegisteredOfficeUkFormProvider" when {
