...
class BankAccountControllerSpec extends PlaySpec with OneAppPerSuite with MockitoSugar {
  ...
  "BankAccountController" must {
    ...
    "get the blank page without values when the page is loaded first" in new Fixture {
      ...
      val result = controller.get(1, RepeatingSectionFlow.Edit)(request) // changed this
    ...
    "get the page with values when the page is loaded again " in new Fixture {
      ...
      val result = controller.get(1, RepeatingSectionFlow.Edit)(request)
    }
    ...
    "on post with valid data in edit mode" in new Fixture {
      ...
      val result = controller.post(1, RepeatingSectionFlow.Edit)(newRequest)
    ...
    "on post with invalid data" in new Fixture {
      ...
      val result = controller.post(0, RepeatingSectionFlow.Edit)(newRequest)
