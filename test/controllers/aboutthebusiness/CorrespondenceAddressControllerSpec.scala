...
class CorrespondenceAddressControllerSpec extends PlaySpec with OneServerPerSuite with MockitoSugar with ScalaFutures {
  ...
  "CorrespondenceAddressController" should {
    ...
    "respond to a get request correctly with different form values" when {
      ...
      "data exists in the keystore" in new Fixture {
        ...
        val aboutTheBusiness = AboutTheBusiness(None, None, None, None, Some(correspondenceAddress))
