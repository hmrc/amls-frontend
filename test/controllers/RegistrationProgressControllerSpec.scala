  ...
  "RegistrationProgressController" when {
    ...
    "redirect to Fee Guidance" when {
      ...
      "at least one of the person in responsible people is nominated officer" in new Fixture {
        ...
        val rp1 = ResponsiblePeople(Some(PersonName("first1", Some("middle"), "last1", None, None)), None, None, None, None, None, Some(positions))
        val rp2 = ResponsiblePeople(Some(PersonName("first2", None, "last2", None, None)), None, None, None, None, None, Some(positions))
