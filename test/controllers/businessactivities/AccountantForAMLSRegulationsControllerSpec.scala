...
class AccountantForAMLSRegulationsControllerSpec extends PlaySpec with OneAppPerSuite with MockitoSugar {
  ...
  "AccountantForAMLSRegulationsController" must {
    ...
    "Get Option:" must {
      ...
      "load the Accountant For AMLSRegulations page" in new Fixture {
        ...
        htmlValue.title mustBe Messages("businessactivities.accountantForAMLSRegulations.title")  + " - " + Messages("progress.businessactivities.name")  + " - " + Messages("title.amls")
      }
