  ...
  "ExpectedAMLSTurnoverController" when {
    ...
    "post is called" must {
      "on post with valid data" in new Fixture {
        ...
        val newRequest: FakeRequest[AnyContentAsFormUrlEncoded] = FakeRequest(POST, routes.ExpectedAMLSTurnoverController.post().url).withFormUrlEncodedBody(
      ...
      "on post with valid data in edit mode" in new Fixture {
        ...
        val newRequest: FakeRequest[AnyContentAsFormUrlEncoded] = test.FakeRequest(POST, routes.ExpectedAMLSTurnoverController.post().url).withFormUrlEncodedBody(
          "expectedAMLSTurnover" -> "zeroPlus"
        )
