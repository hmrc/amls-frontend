...
class AmountOwedControllerSpec extends AmlsSpec with PaymentGenerator {
  ...
  trait Fixture extends AuthorisedFixture with DependencyMocks { self =>
    ...
    val controller = new AmountOwedController(
  ...
  "AmountOwedController" when {
    ...
    "get is called" must {
      "return OK with view" in new Fixture {
        ...
        contentAsString(result) must include(Messages("payments.you.owe.heading") + "200")
      }
    }
  }
}