...
class PositionWithinBusinessControllerSpec extends GenericTestHelper with MockitoSugar {
  ...
  trait Fixture extends AuthorisedFixture {
    ...
    val noNominatedOfficer = ResponsiblePeople(None, None, None, None, None, Some(DefaultValues.noNominatedOfficerPositions), None, None, None, None, Some(true), false, Some(1), Some("test"))
    val hasNominatedOfficer = ResponsiblePeople(None, None, None, None, None, Some(DefaultValues.hasNominatedOfficerPositions), None, None, None, None, Some(true), false, Some(1), Some("test"))
    val hasNominatedOfficerButDeleted = ResponsiblePeople(None, None, None, None, None, Some(DefaultValues.hasNominatedOfficerPositions), None, None, None, None, Some(true), false, Some(1), Some(StatusConstants.Deleted))
  }
