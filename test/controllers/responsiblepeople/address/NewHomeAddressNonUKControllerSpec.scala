    ...
    "post is called" must {
      "redirect to DetailedAnswersController" when {
        "all the mandatory non-UK parameters are supplied" in new Fixture {
          ...
          val nonUKAddress = PersonAddressNonUK("new address line1", Some("new address line2"), None, None, Country("Spain","ES"))
        ...
        "all the mandatory non-UK parameters are supplied and date of move is more then 6 months" in new Fixture {
          ...
          val nCurrentAddress = ResponsiblePersonCurrentAddress(PersonAddressNonUK("new address line1", Some("new address line2"), None, None, Country("Spain","ES")), Some(SixToElevenMonths), Some(DateOfChange(LocalDate.now().minusMonths(7))))
        ...
        "all the mandatory non-UK parameters are supplied and date of move is more then 3 years" in new Fixture {
          ...
          val newCurrentAddress = ResponsiblePersonCurrentAddress(PersonAddressNonUK("new address line1", Some("new address line2"), None, None, Country("Spain","ES")), Some(ThreeYearsPlus), Some(DateOfChange(LocalDate.now().minusMonths(37))))
