...
class AreTheyNominatedOfficerControllerSpec extends GenericTestHelper with MockitoSugar {
  ...
  trait Fixture extends AuthorisedFixture {
    ...
    val noNominatedOfficer = ResponsiblePeople(personName, None, None, None, None, Some(DefaultValues.noNominatedOfficerPositions), None, None, None, None, Some(true), false, Some(1), Some("test"))
    val hasNominatedOfficer = ResponsiblePeople(personName, None, None, None, None, Some(DefaultValues.hasNominatedOfficerPositions), None, None, None, None, Some(true), false, Some(1), Some("test"))
    val withPartnerShip = ResponsiblePeople(personName, None, None, None, None, Some(DefaultValues.hasNominatedOfficerPositions.copy(positions = DefaultValues.hasNominatedOfficerPositions.positions + Partner)), None, None, None, None, Some(true), false, Some(1), Some("test"))
  }
