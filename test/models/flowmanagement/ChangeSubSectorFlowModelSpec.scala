...
class ChangeSubSectorFlowModelSpec extends PlaySpec {

  "ChangeSubSectorFlowModel" must {
    ...
    "have a correct empty value" in {
      ChangeSubSectorFlowModel.empty mustEqual ChangeSubSectorFlowModel()
    }
  }
}
