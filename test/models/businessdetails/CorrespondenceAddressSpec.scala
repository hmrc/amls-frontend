...
class CorrespondenceAddressSpec extends PlaySpec with MockitoSugar {
  ...
  "CorrespondenceAddress" must {
    ...
    val ukAddress = CorrespondenceAddressUk("YourName", "BusinessName", "Line1", "Line2", Some("Line3"), Some("Line4"), "NE1 1NE")
    val nonUkAddress = CorrespondenceAddressNonUk("YourName", "BusinessName", "Line1", "Line2", Some("Line3"), Some("Line4"), Country("Albania", "AL"))
