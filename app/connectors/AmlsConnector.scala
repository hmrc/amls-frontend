...
class AmlsConnector @Inject() (val httpClient: HttpClientV2, val appConfig: ApplicationConfig) extends Logging {
  ...
  def subscribe(subscriptionRequest: SubscriptionRequest, safeId: String, accountTypeId: (String, String))(implicit
  ...
  def view(amlsRegistrationNumber: String, accountTypeId: (String, String))(implicit
    headerCarrier: HeaderCarrier,
    ec: ExecutionContext,
  ...
  def savePayment(paymentId: String, amlsRefNo: String, safeId: String, accountTypeId: (String, String))(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def getPaymentByPaymentReference(paymentReference: String, accountTypeId: (String, String))(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ...
  def getPaymentByAmlsReference(amlsRef: String, accountTypeId: (String, String))(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[Option[Payment]] = {
  ...
  def refreshPaymentStatus(paymentReference: String, accountTypeId: (String, String))(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[PaymentStatusResult] = {
  ...
  def registrationDetails(accountTypeId: (String, String), safeId: String)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ...
  def updateBacsStatus(accountTypeId: (String, String), ref: String, request: UpdateBacsRequest)(implicit
    ec: ExecutionContext,
    hc: HeaderCarrier
  ): Future[HttpResponse] = {
  ...
  def createBacsPayment(accountTypeId: (String, String), request: CreateBacsPaymentRequest)(implicit
    ec: ExecutionContext,
    hc: HeaderCarrier
  ): Future[Payment] = {
