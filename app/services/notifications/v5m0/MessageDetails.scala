...
object MessageDetails {
  ...
  def endDate(contactType: ContactType, endDate: String, url: String, referenceNumber: String): String = {
    contactType match {
      ...
      case AutoExpiryOfRegistration => s"<p>Your business’s registration with HMRC is cancelled. Despite previous reminders to pay the fees imposed under the money laundering regulations you have failed to do so.</p><p>The cancellation will come into effect in 14 days from the date of this notice to allow you to conclude relevant business.</p><p>To be registered by HMRC you must submit a new registration application and pay the correct fees.If your business is not registered with a relevant supervisory body (such as HMRC), you and/or your business may be subject to civil sanctions, such as a fine, or criminal proceedings if you continue to trade in activities covered by the regulations.</p><p>If you disagree with this decision<br>Under the regulations, HMRC must offer you a review of their decision.<br>You have 30 days to:<br><li>Contact us to ask for a HMRC review or</li><li>Appeal directly to an independent tribunal, if you do not want a review</li></p><p>HMRC reviews are carried out by an independent team. You will be notified of the outcome of the review within 45 days unless another time is agreed.</p><p>If you are not satisfied with the conclusion of the review, you still have a right of appeal to a tribunal. These are administered by the Tribunal Service and you will have 30 days to appeal following notification of the outcome of the review.</p><p>HMRC’s money laundering registration policy can be found on www.gov.uk, where you can also find information about what you can do if you disagree with an HMRC decision, including how to request a review of our decision or make appeal to the tribunal.</p>"
      case RenewalReminder => s"<p>It is time to pay your business’s annual fee.</p><p>You need to check and verify that your details are up to date and pay your annual fee in full by ${ endDate }.</p><p>Failing to pay your fee in a timely manner may lead to HMRC cancelling your registration.</p><p>Start this process from your status page. Completing this will tell you the amount of your annual fee.</p><p>HMRCs money laundering registration policy, and details of how to pay your fee can be found on www.gov.uk.</p><p> If your business is not registered with a relevant supervisory body (such as HMRC) you and/or your business may be subject to civil sanctions, such as a fine, or criminal proceedings if you continue to trade in activities covered by the Regulations.</p><p>If you have taken the steps outlined above, please ignore this message,</p>"
  ...
  def reminder(contactType: ContactType, paymentAmount: String, referenceNumber: String): String = {
    contactType match {
      ...
      case ReminderToPayForRenewal => s"<p>HMRC imposes an annual charge for supervision. You need to pay this to continue your registration with HMRC.</p><p>Your payment reference is: ${ referenceNumber }.</p><p>If you do not pay your fees within 28 working days from the date of this message, HMRC will cancel your business’s registration.</p><p>HMRCs money laundering registration policy, and details of how to pay your fee can be found on www.gov.uk.</p><p>If you are experiencing difficulties in carrying out these actions, please contact MLRCIT@hmrc.gov.uk.</p><p>If you continue to trade in activities covered by the Money Laundering Regulations and are not registered with the relevant supervisory body (such as HMRC), you may be subject to civil sanctions or criminal proceedings.</p><p>If you have already paid, please ignore this message.</p>"
