...
object MessageDetails {
  ...
  def reminder(contactType: ContactType, paymentAmount: String, referenceNumber: String): String = {
    contactType match {
      ...
      case ReminderToPayForRenewal => s"<p>You need to pay ${ paymentAmount } for your annual renewal.</p><p>Your payment reference is: ${ referenceNumber }.</p><p>Find details of how to pay on your status page.</p><p>It can take time for some payments to clear, so if you’ve already paid you can ignore this message.</p>"
