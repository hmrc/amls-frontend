...
class SendLargestAmountsOfMoneyFormProvider @Inject() () extends CountryListMappings {

  private val emptyErrorKey = "error.required.renewal.largest.amounts.country"
