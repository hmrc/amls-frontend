...
class CorrespondenceAddressUKFormProvider extends CorrespondenceAddressFormProvider[CorrespondenceAddressUk] {
  ...
  override def toObject: (String, String, String, String, Option[String], Option[String], String) => CorrespondenceAddressUk = {
  ...
  override def fromObject: CorrespondenceAddressUk => Option[(String, String, String, String, Option[String], Option[String], String)] = {
