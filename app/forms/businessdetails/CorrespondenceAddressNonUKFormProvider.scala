...
class CorrespondenceAddressNonUKFormProvider extends CorrespondenceAddressFormProvider[CorrespondenceAddressNonUk] {
  ...
  override def toObject: (String, String, String, String, Option[String], Option[String], String) => CorrespondenceAddressNonUk = {
  ...
  override def fromObject: CorrespondenceAddressNonUk => Option[(String, String, String, String, Option[String], Option[String], String)] = {
