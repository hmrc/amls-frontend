...
object ActivityStartDate {
  ...
  implicit val formRule: Rule[UrlFormEncoded, ActivityStartDate] = From[UrlFormEncoded] { __ =>
    import jto.validation.forms.Rules._
      (__ \ "startDate").read(newAllowedPastAndFutureDateRule("error.required.date", "error.invalid.date.after.1700", "error.invalid.date.past")) map ActivityStartDate.apply
  }
