...
object SoleProprietorOfAnotherBusiness {
  ...
  implicit val formRule: Rule[UrlFormEncoded, SoleProprietorOfAnotherBusiness] =
    From[UrlFormEncoded] { __ =>
      ...
      (__ \ "soleProprietorOfAnotherBusiness").read[Boolean].withError(ValidationError("error.required.rp.sole_proprietor", "booooooop")) map SoleProprietorOfAnotherBusiness.apply
    }
