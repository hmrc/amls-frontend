...
object FormTypes {
  ...
  val maxAccountantRefNoTypeLength = 11
  ...
  val accountantRefNoType = notEmpty compose maxLength(maxAccountantRefNoTypeLength) compose minLength(maxAccountantRefNoTypeLength)
}