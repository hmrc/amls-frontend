...
object FormTypes {
  ...
  val penalisedTypeRegex = "^[a-zA-Z0-9\u00C0-\u00FF !#$%&'‘’\"“”«»()*+,./:;=?@\\[\\]|~£€¥\\u005C\u2014\u2013\u2010\u005F\u005E\u0060\u002d]{1,255}$".r
  ...
  private val penalisedMaxLength = 255
  val penalisedPattern = regexWithMsg(penalisedTypeRegex, "err.text.validation")
  private val penalisedLength = maxWithMsg(penalisedMaxLength, "error.invalid.eab.info.about.penalty")
  private val penalisedRequired = required("error.required.eab.info.about.penalty")
  val penalisedType = penalisedRequired andThen penalisedLength andThen penalisedPattern
