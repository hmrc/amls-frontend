...
object ApplicationConfig extends ServicesConfig {
  ...
  lazy val betaFeedbackUrl = contactHost + getConfigString(s"contact-frontend.beta-feedback-url.authenticated")
  lazy val betaFeedbackUnauthenticatedUrl = contactHost + getConfigString(s"contact-frontend.beta-feedback-url.unauthenticated")
